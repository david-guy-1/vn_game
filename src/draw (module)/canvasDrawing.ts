...
import { fillstyle, bezier } from "./draw_commands";
import { normalize } from "./lines";
...
export function drawRoundedRectangle(context :CanvasRenderingContext2D, x0 : number, y0: number, x1: number, y1: number, r1 : number,r2 : number,cap0 : boolean =false, cap1 : boolean = false,  color :fillstyle = "black", width: number = 1, fill : boolean = false){
